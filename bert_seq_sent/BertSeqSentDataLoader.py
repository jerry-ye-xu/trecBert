...
from customDatasetGenerator import BioASQDatasetGenerator, id_collate

class BertSentClassDataHolder():
    def __init__(
        self,
    ...
    def _build_tokenised_seq(self, seq_a, seq_b=None):
        ...
        return self._tokenize_seq(seq_a, seq_b)
